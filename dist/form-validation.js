...
let iconError = document.querySelector(".Email .text .error");
let iconTrue = document.querySelector(".Email .text .true");
let textPass = document.querySelector(".password .text");
let iconErrorPass = document.querySelector(".password .text .error");
let iconTruePass = document.querySelector(".password .text .true");
let iconOpen = document.querySelector(".Email .icon-email");
let iconOpenTwo = document.querySelector(".password .icons");
let checkInput = function () {
    ...
    password.addEventListener("keyup", function () {
        iconOpenTwo.style.top = "33%";
        PasswordFunc();
    });
    Email.addEventListener("keyup", function () {
        iconOpen.style.top = "33%";
        EmailFunc();
    });
    Email.addEventListener("keyup", function () {
        if (Email.value == "") {
    ...
    password.addEventListener("keyup", function () {
        if (password.value == "") {
            ...
            iconOpenTwo.style.top = "50%";
        }
    });
};
let EmailFunc = function () {
    let EmailRegular = /(\w+\d+@\w+.(com|net|org)|\w+@\d+\w+.(com|net|org))/gi;
...
let submitForm = function () {
    form.onsubmit = function (ele) {
        ...
        let passwordRegular = /^\d{6,}[^a-zA-Z]/gi;
        if (password.value.match(passwordRegular) &&
            Email.value.match(EmailRegular)) {
...
let eyeIcon = document.querySelector(".eyeOff");
